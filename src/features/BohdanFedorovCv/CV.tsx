...
const CV = () => {
    ...
    const handleBeforePrint = async () => {
        setIsPrinting(true);
        setExpandedJobs(Array.from({ length: schema.hasOccupation.length }, (_, i) => i));
    };
                        ...
                        <div data-aos="fade-up">
                            ...
                            <div className="flex flex-wrap gap-4">
                                <a href={`mailto:${schema.email}`} className="contact-button">
                                    <i className="fa fa-envelope mr-2"></i>{schema.email}
                                </a>
                                <a href={schema.contact_information.linkedin} className="contact-button">
                                    <i className="fab fa-linkedin mr-2"></i>LinkedIn
                                </a>
                                <a href={`tel:${schema.contact_information.phone}`} className="contact-button">
                                    <i className="fa fa-phone mr-2"></i>{schema.contact_information.phone}
                                </a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className="prose max-w-none">
                                ...
                                <div className="mb-6">
                                    ...
                                    <ul className="list-disc pl-6 space-y-2">
                                        {(Array.isArray(schema.professionalSummary)
                                            ? schema.professionalSummary.join('\n')
                                            : schema.professionalSummary)
                                            .split('Key strengths:\n')[1]
                                            .split('\n\n')[0]
                                            .split('\n')
                                            .map((strength, index) => (
                                ...
                                >
                                    ...
                                    {expandedJobs.includes(index) && (
                                        <div className="mt-4 space-y-6">
                                            ...
                                            {job.systemFeatures && (
                                                <div className="mb-6">
                                                    <h4 className="text-lg font-semibold mb-3">System Features:</h4>
                                                    <ul className="list-disc list-inside space-y-2">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg">
                            <ul className="space-y-2">
                                {schema.seeks.map((position, index) => (
                                    <li key={index} className="text-lg">• {position}</li>
                                ))}
                            </ul>
                        </div>
                    </section>
